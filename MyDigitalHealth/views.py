...
def packageList(request, package):
	...
	context = {'package': package, 'user': user, 'comments': comments,'sortcardList': sortcardList,'sortPackage': sortPackage, 'sortPackageUser': sortPackageUser, 'filteredGroupsList': filteredGroupsList, 'filteredCardsList': filteredCardsList}
	return render(
		request,
		'packageList.html',
		context
